...
- [sample-regatta.md](sample-regatta.md) — the proposed `-dev-sample-regatta`
  ...
  un-raced; unblocked now that Results Publisher's `.xlsx` write has landed
...
| Full-size sample | a generated, obfuscated full-day regattaData loaded onto the multi-machine Windows setup | proposed, unblocked (Results Publisher's writer landed) — see [sample-regatta.md](sample-regatta.md) |
